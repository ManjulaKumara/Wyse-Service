                                            ...
                                            <table class="invoice" style="width: 95%;">
                                                ...
                                                <tr>
                                                    <td width="50%" style="font-family: Arial; font-size: 22px; color:black; vertical-align: top; text-align: center; border-top-width: 1px; border-top-color: rgb(58, 48, 48); border-top-style: solid;border-bottom-width: 1px; border-bottom-color: rgb(58, 48, 48); border-bottom-style: solid; margin: 0; padding: 10px 0;"
                                                        align="center" valign="top"><h3>Price List</h3>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 5px 0;" valign="middle" colspan="2">
                                                        <table cellpadding="15px" cellspacing="0" style="width: 100%;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th style="text-align: left;border-bottom:1px solid grey;">Price</th>
                                                                <th style="text-align: left;border-bottom:1px solid grey;"> Discounted Price</th>
                                                            </tr>

                                                            @foreach($price_list as $element)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: left;border-bottom:1px solid grey;">{{number_format($element->selling_price, 2)}}</td>
                                                                <td style="text-align: left;border-bottom:1px solid grey;">{{number_format($element->selling_price-($element->discount*$element->selling_price), 2)}}</td>
