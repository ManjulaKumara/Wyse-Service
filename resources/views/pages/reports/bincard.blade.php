                                            ...
                                            <table class="invoice" style="width: 95%;">
                                                ...
                                                <tr>
                                                    <td width="50%" style="font-family: Arial; font-size: 22px; color:black; vertical-align: top; text-align: center; border-top-width: 1px; border-top-color: rgb(58, 48, 48); border-top-style: solid;border-bottom-width: 1px; border-bottom-color: rgb(58, 48, 48); border-bottom-style: solid; margin: 0; padding: 10px 0;"
                                                        align="center" valign="top"><h3>Bin Card</h3>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 5px 0;" valign="middle" colspan="2">
                                                        <table cellpadding="15px" cellspacing="0" style="width: 100%;">
                                                            <tr>
                                                                <td colspan="2" style="text-align: left;border-bottom:1px solid grey;font-size:16px;font-weight:bold;">Code: {{$item->item_code}}</td>
                                                                <td colspan="3" style="text-align: left;border-bottom:1px solid grey;font-size:16px;font-weight:bold;">Name: {{$item->item_name}}</td>
                                                                <td colspan="1" style="text-align: left;border-bottom:1px solid grey;font-size:16px;font-weight:bold;">QIH: {{$qih}}</td>
                                                            </tr>
                                                            <tr>
                                                                <th style="text-align: left;border-bottom:1px solid grey;">Ref Id</th>
                                                                <th style="text-align: left;border-bottom:1px solid grey;">Date</th>
                                                                <th style="text-align: left;border-bottom:1px solid grey;">Transfer Type</th>
                                                                <th style="text-align: left;border-bottom:1px solid grey;"> Status</th>
                                                                <th style="text-align: left;border-bottom:1px solid grey;">Quantity</th>
                                                                <th style="text-align: left;border-bottom:1px solid grey;">Balance</th>

                                                            </tr>

                                                            @foreach($bin_data as $element)
                                                            <tr>

                                                                <td style="text-align: left;border-bottom:1px solid grey;">{{$element->reference_id}}</td>
                                                                <td style="text-align: left;border-bottom:1px solid grey;">{{$element->date}}</td>
                                                                <td style="text-align: left;border-bottom:1px solid grey;">{{$element->transaction_type}}</td>
                                                                <td style="text-align: left;border-bottom:1px solid grey;">{{$element->tran_status}}</td>
                                                                <td style="text-align: left;border-bottom:1px solid grey;">{{$element->transfer_qty}}</td>
                                                                <td style="text-align: left;border-bottom:1px solid grey;">{{$element->balance}}</td>
