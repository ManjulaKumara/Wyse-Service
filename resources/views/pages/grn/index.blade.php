    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                <!--begin::Add new-->
                <a href="{{url('/grns/create')}}"><button type="button" class="btn btn-primary" >Add GRN</button></a>
                <!--end::Add new-->
            </div>
            <!--end::Toolbar-->
        </div>
...
@endsection
@section('opyional_js')
<script src="{{ url('js/form/grns.js')}}"></script>
