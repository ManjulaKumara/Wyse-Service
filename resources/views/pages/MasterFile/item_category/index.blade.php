    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                <!--begin::Add new-->
                <a href="{{url('/item-category/create')}}"><button type="button" class="btn btn-primary" >Add Item Category</button></a>
                <!--end::Add new-->
            </div>
            <!--end::Toolbar-->
        </div>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="table" data-order='[[ 1, "asc" ]]' data-page-length='25'>
            ...
            <thead>
                ...
                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px">Category Code</th>
...
@endsection
@section('opyional_js')
<script src="{{ url('js/form/item_category.js')}}"></script>
