...
<div class="card">
    ...
    <form class="form" method="POST" action="{{url('/items/store')}}">
        @csrf
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-6">
                    ...
                    <input type="number" id="re_order_level" name="re_order_level" class="form-control" required/>
                </div>
            </div><br>
            <div class="form-group row">
                <div class="col-lg-12">
            ...
            <div class="form-group row">
                <div class="col-lg-6">
                    ...
                    <input type="text"  id="discount_rate" name="discount_rate" class="form-control" required/>
                </div>
                <div class="col-lg-6">
                    <label class="required">Item Type</label>
                    <input type="text" id="item_type" name="item_type" class="form-control" required/>
                    {{-- <input type="hidden" id="cust_id" name="id" class="cus_lead_id form-control"/> --}}
                </div>
            </div><br>
            <div class="form-group row">
