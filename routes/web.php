    ...
    Route::group(['middleware'=>['enabled']],function(){
        Route::group(['middleware'=>['read']],function(){
            ...
            Route::group(['prefix'=>'reports'],function(){
                ...
                Route::post('/bin-card',[ReportController::class,'fill_bincard']);
                Route::post('/daily-summary',[ReportController::class,'fill_data_summary']);
                ...
                Route::post('/sales-summary',[ReportController::class,'fill_sales_summary']);

            });
        });
        Route::group(['middleware'=>['create']],function(){
